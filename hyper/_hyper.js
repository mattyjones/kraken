...
module.exports = {
    config: {
        ...
        // Set the initial window size to a consistent value
        hyperWindowSize: {
            width: 1810,
            height: 930,
            startX: 50,
        ...
        // quit hyper when the last terminal window closes
        // https://github.com/cblecker/hyper-quit
        hyperquit: {},

        // set a transparent bg
        // default settings are below
        // https://github.com/dfrankland/hyper-transparent-bg
        transparentBG: {
            WebkitFilter: 'blur(5px)',
            opacity: '0.5'
        },

        // folder icons in the tab bar
