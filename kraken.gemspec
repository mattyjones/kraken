...
Gem::Specification.new do |s|
  s.authors                = 'Matty Jones'

  s.date                   = Date.today.to_s
  s.description            = 'My personal, very opinionated dotfiles and configuration tools'
  s.email                  = '<urlugal@gmail.com>'
  s.executables            = Dir.glob('tools/**/*.rb').map { |file| File.basename(file) }
  ...
  # s.add_development_dependency '', '~> 1.0'
